    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Ayo Kita koding</h1>

                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Satrio Punya <br>Penerapan CI CD berhasil.</p>
